...
<html lang="en">
  ...
  <header id="header">
    <div class="container d-flex">
      ...
      <div class="mr-auto">
        <a href="/"><img src="/IMAGES/oclogo3.png" height="60" width="250"></a>
      ...
      <nav class="nav-menu d-none d-lg-block">
        <ul>
          ...
          <li><a href="#" class="btn" style="color: #fff; background-color: #fd5c28; padding-left: 20px; padding-right: 20px;">START CLASSES FOR FREE</a></li>
